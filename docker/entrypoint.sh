...
installExtensions(){
	...
	~/vscodium/vscodiumforcora/bin/codium --no-sandbox --force --install-extension BriteSnow.vscode-toggle-quotes@0.3.6
	~/vscodium/vscodiumforcora/bin/codium --no-sandbox --force --install-extension genuitecllc.codetogether@2023.1.1
